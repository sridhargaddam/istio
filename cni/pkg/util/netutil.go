...
// GetInterfaceIPv4 returns the first IPv4 address of the specified network interface.
...
// GetInterfaceIPv6 returns the first global-scope IPv6 address of the specified network interface.
